			...
			<?php if (have_posts()) : 
			  ...
			  <div class=" section_inner clearfix">
				...
				<div class="wpb_text_column wpb_content_element h1_para">
					<div class="wpb_wrapper">
						<p style="color: #1778BA; font-size: 24px!important; font-weight: 400!important; line-height: 35px!important; margin-bottom: 25px;">Thank you for requesting your free quote.<br />
One of our representatives will be contacting you in the next 10 minutes.</p>
						<p style="color:#727272; font-weight: 400!important; font-size: 17px!important; line-height: 25px!important; margin-bottom: 25px;">Open a Day Account and <a href="https://account.daytranslations.com/login" target="_self">get a 5% lifetime discount</a> on all your translations.
It’s simple, fast and completely free.</p>
					</div> 
				</div> 
	<div class="separator  transparent   " style="margin-top: 10px;margin-bottom: 10px;"></div>
				...
				<div class="wpb_raw_code wpb_content_element wpb_raw_html">
					<div class="wpb_wrapper">
						<a href="https://account.daytranslations.com/login" target="_self" class="qbutton  center mainBannerBTn" style="">Set Up my DayAccount Now</a>
						<br />
						<a href="/contact-us" target="_self" style="display: block; padding-top: 10px; font-size: 12px; text-decoration: underline;" style="">Or Contact Us</a>
					</div>
				</div>
			</div>
		  </div>
