...
wp_dequeue_script( 'default' ); 
	...
	/*} else {
		wp_register_script( 'bundle', get_stylesheet_directory_uri() . '/js/app.bundle.js' , 'jquery', NULL, TRUE);
...
function wp_remove_all_scripts() {
	global $post;
	if($post->ID=="39218"){
		global $wp_scripts;
		$leave_alone = array(
		...
		// wp_register_script( 'init', get_stylesheet_directory_uri() . '/js/init.js' , 'jquery', NULL, TRUE);
		// wp_enqueue_script( 'init');

		wp_register_script( 'modernizr-bundle', get_stylesheet_directory_uri() . '/js/modernizr-bundle.js' , 'jquery', NULL, TRUE);
		wp_enqueue_script( 'modernizr-bundle');

		wp_register_script( 'bundle', get_stylesheet_directory_uri() . '/js/a.js' , 'jquery', NULL, TRUE);
		wp_enqueue_script( 'bundle');

		// wp_register_script( 'vendor', get_stylesheet_directory_uri() . '/js/b.bundle.js' , 'jquery', NULL, TRUE);
		// wp_enqueue_script( 'vendor');

		// wp_register_script( 'modules', get_stylesheet_directory_uri() . '/js/c.bundle.js' , 'jquery', NULL, TRUE);
		// wp_enqueue_script( 'modules');
	}
}
add_action( 'wp_print_styles', 'wp_remove_all_scripts', 0 );
