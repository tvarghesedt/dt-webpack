		...
		$html.= '<div class="human_carousel_wrapper human human_carousel-beforeLoad offices_carousel-beforeLoad" data-wow-delay="0.1s">';
			...
			$html.= '<ul class="offices_carousel slides">';			
				...
				//while (have_posts()) : the_post();				
					...
					$html.= '<li class="human_content_inner">';
						$html.= '<div class="human-image">';
							$html.= '<img src="https://www.daytranslations.com/wp-content/themes/bridge-child/images/loc-india.jpg" class="human-pic">';
						$html.= '</div>';
						$html.= '<div class="human-details">';				
						$html.= '<a href="https://www.daytranslations.com/locations/india">';		
							$html.= '<div class="human-name">India</div>';
							$html.= '<div class="human-area">GO TO LOCATION</div>';	
							$html.= '</a>';					
						$html.= '</div>';
					$html.= '</li>';
					...
					$html.= '<li class="human_content_inner">';
						$html.= '<div class="human-image">';
							$html.= '<img src="https://www.daytranslations.com/wp-content/themes/bridge-child/images/loc-Saudi-Arabia.jpg" class="human-pic">';
						$html.= '</div>';
						$html.= '<div class="human-details">';
						$html.= '<a href="https://www.daytranslations.com/locations/saudi-arabia">';							
							$html.= '<div class="human-name">Saudi Arabia</div>';
							$html.= '<div class="human-area">GO TO LOCATION</div>';	
							$html.= '</a>';						
						$html.= '</div>';
					$html.= '</li>';
					...
					$html.= '<li class="human_content_inner">';
						$html.= '<div class="human-image">';
							$html.= '<img src="https://www.daytranslations.com/wp-content/themes/bridge-child/images/loc-United-Kingdom.jpg" class="human-pic">';
						$html.= '</div>';
						$html.= '<div class="human-details">';
						$html.= '<a href="https://www.daytranslations.com//locations//united-kingdom">';							
							$html.= '<div class="human-name">United Kingdom</div>';
							$html.= '<div class="human-area">GO TO LOCATION</div>';	
							$html.= '</a>';						
						$html.= '</div>';
					$html.= '</li>';
