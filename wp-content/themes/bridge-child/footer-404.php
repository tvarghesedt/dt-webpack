...
<?php if($display_footer_top || $display_footer_text) { ?>
	<footer <?php if($uncovering_footer){echo 'class="uncover"';} ?>>
		...
		<div class="footer_top_holder" style="display:none;">
...
<!-- EU cookies Code for DayTranslations 2018 -->
<?php
	...
	//echo 'Country => |'.$country.'| IP => '.$ip_address;
	echo '<span style="display:none;">Country => |'.$country.'| IP => '.$ip_address.'</span>';
	global $post;
	if($post->ID == '2648'){		
		echo '<pre>';
		print_r($EUmembercountries);
	}
	if(in_array($country, $EUmembercountries)) {
?>
<script type="text/javascript">
    window.cookieconsent_options = {"message":"This website uses cookies to ensure you get the best experience on our website","dismiss":"Got it!","learnMore":"More info","link":"https://www.daytranslations.com/privacy-policy","theme":"dark-top"};
</script>
<script type="text/javascript" src="<?php echo get_site_url(); ?>/wp-content/themes/bridge-child/cookieconsent.min.js"></script>
<?php }  ?>
<!-- EU cookies Code for DayTranslations 2018 END here-->
</body>
</html>