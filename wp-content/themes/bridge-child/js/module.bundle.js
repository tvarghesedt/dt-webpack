...
/***/ function(module, exports, __webpack_require__) {
	...
	// require('./plugins');
	// require('./jquery.carouFredSel-6.2.1.min');
	__webpack_require__(2);
	 __webpack_require__(3);
	//require('./default_dynamic');
	//require('./default.min');
	// require('./jquery-ui-1.8.13.custom.min');
	// require('./js_composer_front.min');
	//require('./handlebars-1.0.0.min.js');
	//require('./jquery.storelocator.min.js');
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery) {var default_min = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery) {var default_dynamic_var = __webpack_require__(8);
	...
	var initPieChartWithIcon = function() {
	    "use strict";
	...
	var initToCounterPieChart = function($this) {
	    "use strict";
	    $j($this).css("opacity", "1");
	...
	function initFlexSlider() {
	    ...
	    $j(".flexslider").each(function() {
	        ...
	        if (typeof $j(this).data("interval") !== "undefined" && $j(this).data("interval") !== false) {
	            interval = parseFloat($j(this).data("interval")) * 1e3;
	        }
	        var slideshow = true;
	        if (interval === 0) {
	            slideshow = false;
	...
	function initVideoBackgroundSize() {
	    ...
	    $j(".carousel .item .video .video-wrap").each(function(i) {
	        ...
	        var mob_header = $j(window).width() < 1e3 ? $j("header.page_header").height() - 6 : 0;
